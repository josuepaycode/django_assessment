...
def update_customer(request, id):
    ...
    if request.method =='POST':
        ...
        customer.update(name=request.POST.get('name'), paternal_surname=request.POST.get('name'), email=request.POST.get('email'))
        return redirect('main')
...
def create_customer(request):
    if request.method =='POST':
        customer = Customer.objects.create(name=request.POST.get('name'), paternal_surname=request.POST.get('name'), email=request.POST.get('email'))
